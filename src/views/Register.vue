            ...
            <div>
              ...
              <div class="mt-2 text-xs space-y-1">
                <div class="flex items-center">
                  <i :class="[hasMinLength ? 'fas fa-check text-green-400 text-xs' : 'fas fa-circle text-gray-600 text-xs', 'mr-2 w-3']"></i>
                  <span :class="hasMinLength ? 'text-green-400' : 'text-gray-500'">Mínimo de 8 caracteres</span>
                </div>
                <div class="flex items-center">
                  <i :class="[hasNumber ? 'fas fa-check text-green-400 text-xs' : 'fas fa-circle text-gray-600 text-xs', 'mr-2 w-3']"></i>
          ...
          <div class="w-full max-w-md">
            ...
            <form @submit.prevent="handleRegister" class="space-y-5">
              ...
              <div>
                ...
                <div class="mt-2 text-xs space-y-1">
                  <div class="flex items-center">
                    <i :class="[hasMinLength ? 'fas fa-check text-green-400' : 'fas fa-circle text-gray-600', 'mr-2 text-xs w-3']"></i>
                    <span :class="hasMinLength ? 'text-green-400' : 'text-gray-500'">Mínimo de 8 caracteres</span>
                  </div>
                  <div class="flex items-center">
                    <i :class="[hasNumber ? 'fas fa-check text-green-400' : 'fas fa-circle text-gray-600', 'mr-2 text-xs w-3']"></i>
                    <span :class="hasNumber ? 'text-green-400' : 'text-gray-500'">Pelo menos um número</span>
                  </div>
                </div>
              </div>
  ...
  const handleRegister = async (event) => {
    ...
    try {
      ...
      let config = {
        ...
        url: 'https://api-polarium.gbetss.com.br/api/user/register',
        headers: { 
      ...
      if (response.status === 200 || response.status === 201) {
        showToast(t.value.accountCreated || 'Conta criada com sucesso!')
        setTimeout(() => {
          router.push('/login')
        }, 1000)
      }
